...
<html>
	...
	<body>
		...
		<section>
			<form name="form" method="post" action="./Join02Ok">
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_newsletter_dl">
						...
						<dd>
							<span>(이메일)을 통한 상품 및 이벤트 정보 수신에 동의합니다.</span>
							<div>
					...
					<dl id="join_sms_dl">
						...
						<dd>
							<span>(SMS)를 통한 상품 및 이벤트 정보 수신에 동의합니다.</span>
							<div>
				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_interests_dl">
						<dt>
							<label for="hoddy">관심사</label>
						</dt>
						<dd>
							<ul>
								<li>
									<input type="checkbox" name="hoddy" id="computer" value="computer" />
									<label for="computer">컴퓨터/인터넷</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="movie" value="movie" />
									<label for="movie">영화/비디오</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="music" value="music" />
									<label for="music">음악</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="shopping" value="shopping" />
								...
								<li>
									<input type="checkbox" name="hoddy" id="culture" value="culture" />
									<label for="culture">문화/예술</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="parenting" value="parenting" />
									<label for="parenting">육아/아동</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="cooking" value="cooking" />
									<label for="parenting">요리</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="interier" value="interier" />
									<label for="interier">인테리어</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="leisure" value="leisure" />
									<label for="leisure">레저/여가</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="health" value="health" />
									<label for="health">건강/다이어트</label>
								</li>
								<li>
									<input type="checkbox" name="hoddy" id="fashion" value="fashion" />
